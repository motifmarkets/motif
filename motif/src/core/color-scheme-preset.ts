...
export namespace ColorSchemePreset {
    ...
    namespace Pastel {
        ...
        const itemsObject: ItemsObject = {
            ...
            Grid_RecordRecentlyAddedBorder: { id: ColorScheme.ItemId.Grid_RecordRecentlyAddedBorder, bkgd: '#CFFFFF', fore: NoneColor },
            ...
            Grid_ScrollbarThumb: { id: ColorScheme.ItemId.Grid_ScrollbarThumb, bkgd: NoneColor, fore: GrayTextColor },
    ...
    namespace Dark {
        ...
        const itemsObject: ItemsObject = {
            ...
            MenuBar_OverlayItem_Disabled: { id: ColorScheme.ItemId.MenuBar_OverlayItem_Disabled, bkgd: inherit, fore: '#686869' },
            MenuBar_OverlayItemHighlighted: { id: ColorScheme.ItemId.MenuBar_OverlayItemHighlighted, bkgd: '#094771', fore: '#ffffff' },
            MenuBar_OverlayItemDivider: { id: ColorScheme.ItemId.MenuBar_OverlayItemDivider, bkgd: '', fore: '#686869' },
            ...
            Grid_FocusedCellBorder: { id: ColorScheme.ItemId.Grid_FocusedCellBorder, bkgd: '#D3D3D1', fore: 'white' },
            ...
            Grid_RecordRecentlyAddedBorder: { id: ColorScheme.ItemId.Grid_RecordRecentlyAddedBorder, bkgd: '#8C5F46', fore: inherit },
            Grid_ValueRecentlyModifiedBorder: { id: ColorScheme.ItemId.Grid_ValueRecentlyModifiedBorder, bkgd: '#8C5F46', fore: '#8C5F46' },
            Grid_ValueRecentlyModifiedUpBorder: { id: ColorScheme.ItemId.Grid_ValueRecentlyModifiedUpBorder, bkgd: '#64FA64', fore: '#64FA64' },
            Grid_ValueRecentlyModifiedDownBorder: { id: ColorScheme.ItemId.Grid_ValueRecentlyModifiedDownBorder, bkgd: '#4646FF', fore: '#4646FF' },
            Grid_UpValue: { id: ColorScheme.ItemId.Grid_UpValue, bkgd: 'green', fore: '#64FA64' },
            Grid_DownValue: { id: ColorScheme.ItemId.Grid_DownValue, bkgd: 'red', fore: '#4646FF' },
            ...
            Grid_NewsHeadlineOnlyAlt: { id: ColorScheme.ItemId.Grid_NewsHeadlineOnlyAlt, bkgd: inherit, fore: inherit },
            Grid_OrderBuy: { id: ColorScheme.ItemId.Grid_OrderBuy, bkgd: '#34574b', fore: 'white' },
            Grid_OrderBuyAlt: { id: ColorScheme.ItemId.Grid_OrderBuyAlt, bkgd: '#325340', fore: 'white' },
            Grid_PriceBuy: { id: ColorScheme.ItemId.Grid_PriceBuy, bkgd: '#386323', fore: 'white' },
            Grid_PriceBuyAlt: { id: ColorScheme.ItemId.Grid_PriceBuyAlt, bkgd: '#4d6535', fore: 'white' },
            Grid_OrderSell: { id: ColorScheme.ItemId.Grid_OrderSell, bkgd: '#bd5e32', fore: 'white' },
            Grid_OrderSellAlt: { id: ColorScheme.ItemId.Grid_OrderSellAlt, bkgd: '#a9542d', fore: 'white' },
            Grid_PriceSell: { id: ColorScheme.ItemId.Grid_PriceSell, bkgd: '#bf362c', fore: 'white' },
            Grid_PriceSellAlt: { id: ColorScheme.ItemId.Grid_PriceSellAlt, bkgd: '#b23229', fore: 'white' },
            Grid_PriceSellOverlap: { id: ColorScheme.ItemId.Grid_PriceSellOverlap, bkgd: '#784EF5', fore: 'white' },
            Grid_PriceSellOverlapAlt: { id: ColorScheme.ItemId.Grid_PriceSellOverlapAlt, bkgd: '#784EF5', fore: 'white' },
            ...
            Grid_PriceHasMyOrder: { id: ColorScheme.ItemId.Grid_PriceHasMyOrder, bkgd: '#C8B900', fore: 'white' },
            Grid_PriceHasMyOrderAlt: { id: ColorScheme.ItemId.Grid_PriceHasMyOrderAlt, bkgd: '#C8B900', fore: 'white' },
            ...
            Grid_ScrollbarThumb: { id: ColorScheme.ItemId.Grid_ScrollbarThumb, bkgd: inherit, fore: 'lightgray' },
            ...
            Panel_Divider: { id: ColorScheme.ItemId.Panel_Divider, bkgd: inherit, fore: '#686869' },
            Panel_Splitter: { id: ColorScheme.ItemId.Panel_Splitter, bkgd: inherit, fore: inherit },
            Panel_ItemHover: { id: ColorScheme.ItemId.Panel_ItemHover, bkgd: '#272727', fore: NoneColor },
