...
@Component({
    selector: 'app-scan-notifiers',
    templateUrl: './scan-notifiers-ng.component.html',
    styleUrls: ['./scan-notifiers-ng.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ScanNotifiersNgComponent extends ContentComponentBaseNgDirective implements  OnInit, OnDestroy, AfterViewInit {
