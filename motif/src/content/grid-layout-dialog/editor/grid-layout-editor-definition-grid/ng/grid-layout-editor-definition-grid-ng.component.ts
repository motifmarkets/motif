...
@Component({
    selector: 'app-grid-layout-editor-definition-grid',
    templateUrl: './grid-layout-editor-definition-grid-ng.component.html',
    styleUrls: ['./grid-layout-editor-definition-grid-ng.component.scss'],

    changeDetection: ChangeDetectionStrategy.OnPush
})
export class GridLayoutEditorDefinitionGridNgComponent extends ContentComponentBaseNgDirective implements AfterViewInit {
    @ViewChild(RecordGridNgComponent, { static: true }) private _gridComponent: RecordGridNgComponent;

    recordFocusEventer: GridLayoutEditorDefinitionGridNgComponent.RecordFocusEventer | undefined;
    gridClickEventer: GridLayoutEditorDefinitionGridNgComponent.GridClickEventer | undefined;
    ...
    private _columnFilterId: GridLayoutEditorDefinitionGridNgComponent.ColumnFilterId = GridLayoutEditorDefinitionGridNgComponent.ColumnFilterId.ShowAll;
    ...
    public get columnFilterId(): GridLayoutEditorDefinitionGridNgComponent.ColumnFilterId { return this._columnFilterId; }
    public set columnFilterId(value: GridLayoutEditorDefinitionGridNgComponent.ColumnFilterId) {
    ...
    ngAfterViewInit() {
        ...
        this._grid = this._gridComponent.createGrid(this._recordStore, GridLayoutEditorDefinitionGridNgComponent.frameGridProperties);
    ...
    private applyColumnFilter(): void {
        ...
        switch (value) {
            case GridLayoutEditorDefinitionGridNgComponent.ColumnFilterId.ShowAll:
                this._grid.applyFilter((record) => showAllFilter(record));
                break;

            case GridLayoutEditorDefinitionGridNgComponent.ColumnFilterId.ShowVisible:
                this._grid.applyFilter((record) => showVisibleFilter(record));
                break;

            case GridLayoutEditorDefinitionGridNgComponent.ColumnFilterId.ShowHidden:
...
export namespace GridLayoutEditorDefinitionGridNgComponent {
