...
export const enum FeedIdEnum {
    ...
    Market_PtxNormal = 'Market_PtxNormal',
    Market_FnsxNormal = 'Market_FnsxNormal',
    Market_FpsxNormal = 'Market_FpsxNormal',
    Market_CfxNormal = 'Market_CfxNormal',
    Market_DaxNormal = 'Market_DaxNormal',
    News_Asx = 'News_Asx',
    News_Nsx = 'News_Nsx',
    News_Nzx = 'News_Nzx',
    News_Myx = 'News_Myx',
