...
export namespace FeedIdImplementation {
    export function toApi(value: FeedId): FeedIdApi {
        switch (value) {
            ...
            case FeedId.Market_PtxNormal: return FeedIdEnumApi.Market_PtxNormal;
            case FeedId.Market_FnsxNormal: return FeedIdEnumApi.Market_FnsxNormal;
            case FeedId.Market_FpsxNormal: return FeedIdEnumApi.Market_FpsxNormal;
            case FeedId.Market_CfxNormal: return FeedIdEnumApi.Market_CfxNormal;
            case FeedId.Market_DaxNormal: return FeedIdEnumApi.Market_DaxNormal;
    ...
    export function fromApi(value: FeedIdApi): FeedId {
        ...
        switch (enumValue) {
            ...
            case FeedIdEnumApi.Market_PtxNormal: return FeedId.Market_PtxNormal;
            case FeedIdEnumApi.Market_FnsxNormal: return FeedId.Market_FnsxNormal;
            case FeedIdEnumApi.Market_FpsxNormal: return FeedId.Market_FpsxNormal;
            case FeedIdEnumApi.Market_CfxNormal: return FeedId.Market_CfxNormal;
            case FeedIdEnumApi.Market_DaxNormal: return FeedId.Market_DaxNormal;
