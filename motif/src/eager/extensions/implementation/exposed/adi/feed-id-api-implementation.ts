...
export namespace FeedIdImplementation {
    export function toApi(value: FeedId): FeedIdApi {
        switch (value) {
            ...
            case FeedId.Market_PtxMain: return FeedIdEnumApi.Market_PtxMain;
            case FeedId.Market_FnsxMain: return FeedIdEnumApi.Market_FnsxMain;
            case FeedId.Market_FpsxMain: return FeedIdEnumApi.Market_FpsxMain;
            case FeedId.Market_CfxMain: return FeedIdEnumApi.Market_CfxMain;
            case FeedId.Market_DaxMain: return FeedIdEnumApi.Market_DaxMain;
    ...
    export function fromApi(value: FeedIdApi): FeedId {
        ...
        switch (enumValue) {
            ...
            case FeedIdEnumApi.Market_PtxMain: return FeedId.Market_PtxMain;
            case FeedIdEnumApi.Market_FnsxMain: return FeedId.Market_FnsxMain;
            case FeedIdEnumApi.Market_FpsxMain: return FeedId.Market_FpsxMain;
            case FeedIdEnumApi.Market_CfxMain: return FeedId.Market_CfxMain;
            case FeedIdEnumApi.Market_DaxMain: return FeedId.Market_DaxMain;
