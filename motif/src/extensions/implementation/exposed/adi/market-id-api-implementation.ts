...
import { MarketId } from 'src/adi/internal-api';
...
export namespace MarketIdImplementation {
    export function toApi(value: MarketId): MarketIdApi {
        switch (value) {
            ...
            case MarketId.Nzfox: throw new AssertInternalError('MIAITANZF98887722');
            case MarketId.Nzx: throw new AssertInternalError('MIAITANZX98887722');
