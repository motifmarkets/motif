...
import { DesktopAccessService, DitemFrame, ExtensionDitemFrame } from 'src/ditem/internal-api';
import { ExtensionHandle, JsonElement, JsonValue } from 'src/sys/internal-api';
import {
